...
//		System.out.println(emp1);
		...
		Employee2<String,Integer> emp2 = new Employee2<String,Integer>("홍길동",2019001); //int타입이 Integer로 바뀜 BOXING
...
class Employee2<T,P extends Number>{ //제약조건 extends 상속을 통해 타입만듬.
